...
## the signal of different histone PTMs at enhancers
#******************************************************
...
# This is for proximal enhancers
# You should change it to the data from distal enhancers,
# if you wish to analyse those
h4k20me1 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H4K20me1.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k4me1 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K4me1.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k4me2 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K4me2.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k4me3 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K4me3.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k27ac <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K27ac.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k36me3 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K36me3.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k27me3 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K27me3.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k9me3 <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K9me3.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k9ac <-
  vroom("data/enhancers/pvalue_marks/proximal.enhancers.first.TSS/H3K9ac.matrix.after.QN.merged.tsv",
    skip = 1,
    col_names = c(
      "gene_id",
      "000", "003", "006", "009", "012", "018",
...
h3k27ac <-
  h3k27ac %>%
  #separate_wider_position(gene_id, c(gene_id = 15), too_many = "drop") %>% # you should use this for every mark if you are processing the distal enhancer data
...
# Find genes that have the mark in all timepoints
