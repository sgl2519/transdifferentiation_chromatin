cd ../analysis/enhancers/proximal.enhancers.first.TSS/

#******
# 1. prepare bed file of coordinates
ln -s ../../../bed.files/proximal.enhancers.bed proximal.enhancers.bed
#******

mkdir ../analysis/enhancers/proximal.enhancers.first.TSS/all.marks
